<template>
    <div>
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow min-h-[500px]">
            <a href="#">
...
export default {
  props: {
    ...
    imageSrc: {
      type: String,
      default: 'https://img.freepik.com/premium-photo/high-angle-view-software-developer-writing-code-while-using-computer-data-systems-office_236854-44145.jpg?size=626&ext=jpg&ga=GA1.1.1224184972.1714608000&semt=sph'
    }
  }
};
</script>