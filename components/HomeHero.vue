<template>
    <div>
        <div class="relative min-h-[700px] w-full flex items-center justify-center text-center bg-cover bg-center"
            ...
            <main class="px-4 sm:px-6 lg:px-8 z-10">
                <div class="text-center">
                    <h2
                        ...
                        <span class="text-yellow-100 font-bold">Welcome!</span> Read our latest blogs 
                    </h2>
